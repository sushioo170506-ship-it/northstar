...
本附录使用工作流议题标题建立“来源—议题”机器审计映射，不新增事实判断。

### GPT-Live应用方向探索：产品定位、技术架构、能力边界、竞争格局、市场需求与落地场景的概念、范围与评价标准是什么？

- <a id="cite-S-OAI-LIVE-1"></a>[OpenAI：Introducing GPT‑Live](https://openai.com/index/introducing-gpt-live/)
- <a id="cite-S-MOSHI-1"></a>[Moshi论文](https://arxiv.org/abs/2410.00037)
- <a id="cite-S-FD-SURVEY-1"></a>[全双工语音对话系统综述](https://arxiv.org/abs/2606.19453)

### GPT-Live应用方向探索：产品定位、技术架构、能力边界、竞争格局、市场需求与落地场景的现状、规模与变化是什么？

- <a id="cite-S-OAI-HELP-1"></a>[OpenAI：ChatGPT Voice](https://help.openai.com/en/articles/20001274-chatgpt-voice)
- <a id="cite-S-GOOGLE-LIVE-1"></a>[Google：Gemini 3.1 Flash Live](https://blog.google/innovation-and-ai/technology/developers-tools/build-with-gemini-3-1-flash-live/)
- <a id="cite-S-SEEDUPLEX-1"></a>[字节跳动Seed：Seeduplex](https://seed.bytedance.com/zh/blog/introducing-seed-full-duplex-speech-llm-attentive-listening-robust-interference-suppression-enabling-more-natural-interaction)

### GPT-Live应用方向探索：产品定位、技术架构、能力边界、竞争格局、市场需求与落地场景的驱动机制与关键证据是什么？

- <a id="cite-S-OAI-SAFETY-1"></a>[GPT‑Live系统卡原始页面](https://deploymentsafety.openai.com/gpt-live/introduction)
- <a id="cite-S-MINMO-1"></a>[MinMo论文](https://arxiv.org/abs/2501.06282)
- [Moshi论文](https://arxiv.org/abs/2410.00037)

### GPT-Live应用方向探索：产品定位、技术架构、能力边界、竞争格局、市场需求与落地场景的方案比较与适用条件是什么？

- [OpenAI：Introducing GPT‑Live](https://openai.com/index/introducing-gpt-live/)
- [Google：Gemini 3.1 Flash Live](https://blog.google/innovation-and-ai/technology/developers-tools/build-with-gemini-3-1-flash-live/)
- [字节跳动Seed：Seeduplex](https://seed.bytedance.com/zh/blog/introducing-seed-full-duplex-speech-llm-attentive-listening-robust-interference-suppression-enabling-more-natural-interaction)

### GPT-Live应用方向探索：产品定位、技术架构、能力边界、竞争格局、市场需求与落地场景的风险、边界与行动建议是什么？

- [GPT‑Live系统卡原始页面](https://deploymentsafety.openai.com/gpt-live/introduction)
- <a id="cite-S-AFFECTIVE-1"></a>[OpenAI与MIT Media Lab：情感使用研究](https://openai.com/index/affective-use-study/)
...
1. <a id="ref-S-OAI-LIVE"></a>[OpenAI：Introducing GPT‑Live](https://openai.com/index/introducing-gpt-live/) [↩1](#cite-S-OAI-LIVE-1)
2. <a id="ref-S-OAI-HELP"></a>[OpenAI：ChatGPT Voice](https://help.openai.com/en/articles/20001274-chatgpt-voice) [↩1](#cite-S-OAI-HELP-1)
3. <a id="ref-S-OAI-SAFETY"></a>[OpenAI：GPT‑Live System Card](https://deploymentsafety.openai.com/gpt-live/introduction) [↩1](#cite-S-OAI-SAFETY-1)
4. <a id="ref-S-GOOGLE-LIVE"></a>[Google：Gemini 3.1 Flash Live](https://blog.google/innovation-and-ai/technology/developers-tools/build-with-gemini-3-1-flash-live/) [↩1](#cite-S-GOOGLE-LIVE-1)
5. <a id="ref-S-SEEDUPLEX"></a>[字节跳动Seed：Seeduplex](https://seed.bytedance.com/zh/blog/introducing-seed-full-duplex-speech-llm-attentive-listening-robust-interference-suppression-enabling-more-natural-interaction) [↩1](#cite-S-SEEDUPLEX-1)
6. <a id="ref-S-MOSHI"></a>[Moshi论文](https://arxiv.org/abs/2410.00037) [↩1](#cite-S-MOSHI-1)
7. <a id="ref-S-MINMO"></a>[MinMo论文](https://arxiv.org/abs/2501.06282) [↩1](#cite-S-MINMO-1)
8. <a id="ref-S-FD-SURVEY"></a>[全双工语音对话系统综述](https://arxiv.org/abs/2606.19453) [↩1](#cite-S-FD-SURVEY-1)
9. <a id="ref-S-AFFECTIVE"></a>[OpenAI与MIT Media Lab：情感使用研究](https://openai.com/index/affective-use-study/) [↩1](#cite-S-AFFECTIVE-1)
